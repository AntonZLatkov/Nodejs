...
function checkFormEmpty(e,t,n){$(e).on("click",function(e){var a=!0;$.each(t,function(e,t){if(""===$(t).val())return a=!1,alert(n),!1}),a||e.preventDefault()})}function checkImageRequest(e,t,n,a){$(e).on("submit",function(n){if(!$(this).attr("validated")){n.preventDefault();var r=$(t).val();return $.ajax({type:"GET",url:r,error:function(){alert(a)},success:function(t,n,r){console.log("Success");var c=r.getResponseHeader("content-type")||"";"image/jpg"==c?($(e).attr("validated",!0),$(e).submit()):alert(a)}}),!1}return!0})}